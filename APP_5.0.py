...
presencial = planejado = planejado_vencido = home = ferias = banco = folga = dayoff = folga_plantao = 0
...
if user.get("tipo") == "gestor":
    ...
    for membro in equipe:
        ...
        pres = plan = home = ferias = banco = folga = folga_plantao = 0
        ...
        c6.metric("🟢 Folga", folga)
        c7.metric("🔄 Plantão", folga_plantao)
        ...
        if dias_folga:
            st.write(f"🟢 Folga: {sorted(dias_folga)}")
