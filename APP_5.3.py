    ...
    if st.sidebar.button("Cadastrar"):
        if email and nome and gestor:
            ...
            if ref.exists:
                ...
                st.sidebar.success("Cadastrado com sucesso")
        else:
...
if restante <= 0:
    ...
    st.info("🟡 Meta atingida se seguir o planejado")
else:
    st.warning(f"⚠️ Ainda faltam {restante} dias presenciais")
